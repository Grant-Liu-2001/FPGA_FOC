...
// 功能：UART发送器，格式为：9600,7,n,1，可以把 i_val0, i_val1, i_val2, i_val3 变成10进制格式，放在一行里，通过 UART 发送出去，

module uart_monitor #(
    parameter [15:0] CLK_DIV = 16'd6250 // UART分频倍率，例如若时钟频率为 60MHz, CLK_DIV=6250，则 UART 波特率为 60MHz/6250=9600 
) (
    input  wire               rstn,
    input  wire               clk,
    input  wire               i_en,
